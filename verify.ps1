...
$required=@('index.html','styles.css','navigation.css','feedback.css','app.js','sw.js','manifest.json','schedule.json','syllabus.json')
...
Write-Host "All checks passed: $($required.Count) files, 9-chapter question coverage, mobile navigation, cloud sync controls and local persistence."
